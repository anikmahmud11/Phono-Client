...
const Product = () => {
    ...
    return (
        <div>
            <h1 className=" p-3 service-header text-center text-danger fw-bold mt-3">Our Products</h1>
            <p className="text-danger blockquote fw-light text-center">FIND YOUR PERFECT MATCH</p>
